...
export function AppFooter() {
  ...
  const links = [
    ...
    ...(locale === "es" ? [{ label: t.guides, href: "/guias" }] : []),
    ...(locale === "es" ? [{ label: t.stats, href: "/estadisticas" }] : []),
    ...(locale === "es"
      ? [{ label: t.research, href: "/investigaciones" }]
      : []),
    { label: t.contact, href: localizedHref("/contacto", locale) },
    { label: t.github, href: githubUrl },
  ];
