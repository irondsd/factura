...
const DESCRIPTION =
  "Novedades sobre Factura, las facturas del hogar y los cambios que afectan el costo de vida en Argentina.";
const INTRO =
  "Actualizaciones y contexto sobre las facturas del hogar, los datos que las explican y las novedades de Factura.";
