export const meta = {
  ...
  cta: "¿Cuánto pagas de impuestos por tu casa al año?",
  keywords: [
    "que es el abl",
...
Es decir: no eliges entre "pagar el impuesto" y "pagar la basura". Eliges entre **pagar en doce cuotas o pagar el año completo de entrada**. Lo desarrollamos en [pago anual o cuotas mensuales del ABL](/guias/pago-anual-o-cuotas-mensuales-del-abl).
...
- **Porcentual fiscal de la unidad:** qué porción del edificio te corresponde. En un departamento no pagas por el edificio entero, sino por tu porcentaje —el mismo criterio con el que [se calculan las expensas](/guias/como-se-calculan-las-expensas).
...
Factura lee la boleta de AGIP y extrae la partida, la cuota, el vencimiento y el total, y arma la serie mes a mes automáticamente. Así ves la evolución real del ABL junto a tu [luz](/guias/como-leer-la-factura-de-edesur), tu [gas](/guias/como-leer-la-factura-de-metrogas) y tus expensas en un solo tablero. Si solo tienes el papel, aprende a [escanearlo con el celular](/guias/como-escanear-una-factura-con-el-celular).

<RelatedGuides />

<ClosingCta title="Cuánto pagas de impuestos al año">
