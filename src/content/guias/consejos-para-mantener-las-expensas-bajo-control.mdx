export const meta = {
  ...
  description:
    "Consejos concretos para controlar las expensas de tu edificio: qué revisar cada mes, qué derechos tienes como copropietario y dónde están los ahorros reales.",
  summary:
