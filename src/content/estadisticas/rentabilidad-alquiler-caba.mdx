...
export const meta = {
  ...
  description:
    "Cuánto rinde por año un departamento comprado para alquilar en cada barrio de CABA, y en cuántos años de alquiler se recupera la inversión, con el mapa y la tabla.",
  summary:
  ...
  preview: "/img/estadisticas/previews/rentabilidad-alquiler-caba.jpg",
  cta: "Ya sabés lo que rinde. Mira lo que se lleva la boleta.",
  keywords: [
...
<PaginaRelacionada href="/estadisticas/precio-m2-caba">
  El precio del metro cuadrado en venta, en dólares, barrio por barrio: el
  denominador de esta cuenta.
</PaginaRelacionada>

<PaginaRelacionada href="/estadisticas/alquiler-caba">
  El precio de los alquileres, en pesos por mes, para los mismos barrios y el
  mismo trimestre: el numerador.
</PaginaRelacionada>
...
<ClosingCta title="La rentabilidad neta la escriben las boletas">
  Esta cuenta es bruta: no descuenta expensas, ABL, seguro ni los meses sin
  inquilino. Factura lee los PDF de cada servicio de tu propiedad y arma el
  gasto real mes a mes, que es exactamente lo que hay que restarle a este
  rendimiento para saber qué queda.
</ClosingCta>
