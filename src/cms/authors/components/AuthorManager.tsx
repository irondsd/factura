    ...
    <>
      ...
      >
        <span className="flex items-baseline gap-3">
          <span className="font-display text-[21px] font-semibold tracking-[-0.015em]">Autores</span>
          <span className="font-mono text-micro tracking-label-wide text-muted uppercase">Global</span>
        </span>
        <span className="mt-2 block font-mono text-[13px] leading-[1.6] text-muted">Administra quién firma y verifica el contenido del sitio.</span>
      </button>
