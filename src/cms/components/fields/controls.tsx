...
// The primitives every metadata field is built out of. Extracted so the four
// fields that grew their own file — keywords, categories, the FAQ, the sources —
// share one input, one counter and one chip list with the plain text boxes
